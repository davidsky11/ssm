...
public class WatermarkBean {
	...
	public WatermarkBean(Boolean watermark) {
		this(watermark, null);
	}

	public WatermarkBean(Boolean watermark, String imagePath) {
		this(watermark, imagePath, null, null, null, null, null, null);
	}

	public WatermarkBean(Boolean watermark, String imagePath, Integer alpha, Integer position, Integer paddingX, Integer paddingY, Integer minWidth, Integer minHeight) {
	...
	public Boolean getWatermark() {
		return watermark != null && watermark && !StringUtil.isNullOrEmpty(getImagePath());
	}
