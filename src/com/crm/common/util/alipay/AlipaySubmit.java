package com.crm.common.util.alipay;
...
public class AlipaySubmit {
	 ...
	 * @return 提交表单HTML文本
	 */
	public static String buildRequest(String key, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		// 待请求参数数组
	 ...
	 * @return 提交表单HTML文本
	 */
	public static String buildRequest(String key, Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(key, sParaTemp);
		List<String> keys = new ArrayList<String>(sPara.keySet());
		StringBuffer sbHtml = new StringBuffer();
	 ...
	 * @throws Exception
	 */
	public static String buildRequest(String key, String strParaFileName, String strFilePath, Map<String, String> sParaTemp) throws Exception {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(key, sParaTemp);
