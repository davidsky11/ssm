 ...
 * @Author:    		kevin
 * @CreateDte:		2016年8月6日 上午10:30:33
 *
 */
    ...
    public boolean preHandle(HttpServletRequest request,  
        ...
        if(user == null){
        	...
        	if(cookies!=null && cookies.length>0){
	  			  ...
	  			  if(cookieValue==null){
	  				  if (!url.contains("syslogin") && url.contains("login")){
	  					  return true;
	  				  }
	  				  ...
	  				  if(userList != null && userList.size() > 0){
	  					  ...
	  					  if (temp != null) {
		  					  ...
		  					  String md5ValueFromUser = MD5.md5crypt(temp.getUsername() + ":" + temp.getPassword() + ":" + temp.getUserType() + ":" + validTimeInCookie + ":" + Const.COOKIEDOMAINNAME);
