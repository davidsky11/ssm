 ...
 * @Description 
 * @Author		kevin 
 * @CreateTime  2016年9月5日 上午12:05:20
 * @Version 	V1.0    
 */
public class PhoneRecharge {
	
	// HttpClient请求的相关设置，可以不用配置，用默认的参数，这里设置连接和超时时长（毫秒）
	public static RequestConfig config = RequestConfig.custom().setConnectTimeout(30000)
			.setSocketTimeout(30000).build();
	public static final String key = Const.JUHE_PHONE_APPKEY;  // 申请的接口Appkey
	public static final String openId = Const.JUHE_OPENID;  // 在个人中心查询
	...
	*/
	...
	public static void main(String[] args) {
		...
		String result = "";
		try {
			result = onlineOrder("15071493575", 10, orderId);
		} catch (Exception e) {
			e.printStackTrace();
		}
