...
<script type="text/javascript">
	...
	//编辑用户信息
 	function editAccount(){
	 	...
	 	if (row){
		 	...
		 	url = path+"/account/editAccount?id="+id;
		 	mesTitle = '编辑用户成功';
	 	}else{
	...
	//删除用信息
 	function deleteAccount(){
	 	...
	 	if (row){
		 	...
		 	$('#fm').form('load',row);//这句话有问题，第一次加载时正确的，第二次就出错了，还保持第一次的数据
		 	url = path+"/account/deleteAccount?id="+id;
		 	mesTitle = '删除用户成功';
	 	}else{
	...
	//快速查询
 	function searchAccountQ(){
	 	var row = $('#datagrid').datagrid('getSelected');
	 	url = path+"/account/editAccount?username="+$('#search_username').val;
	}
	...
	//查询
 	function searchUser(){
		...
		$('#fmsearch').form('clear');
		url = path+"/account/searchAccount";
		mesTitle = '查询用户成功';
	}
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<div id="toolbar">
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deleteAccount();">删除</a>
		...
		<div id="dlg-del-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="saveAccount_del()" style="width:90px">删除</a> 
			<a href="javascript:void(0)" class="easyui-linkbutton"
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="searchAccount()" style="width:90px">查询</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton"
